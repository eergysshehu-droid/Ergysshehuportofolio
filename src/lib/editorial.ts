...
export const defaults = {
  ...
  seoDescriptionSq:
    'Ergys Shehu është fotograf, videograf dhe regjisor i vlerësuar me çmime, aktiv në të gjithë Shqipërinë për dasma, modë, portrete, evente, fushata komerciale, videoklipe dhe bashkëpunime kreative, me projekte edhe ndërkombëtare.'
};
